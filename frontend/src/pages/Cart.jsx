...
const Cart = () => {
    ...
    const shipping = subtotal > 299 ? 0 : 19;
    ...
    const loadCart = async () => {
        try {
            ...
            if (res.data.success) {
                dispatch(setCart(res.data.cart)); // Note: Added likely data path based on common patterns
            }
        } catch (error) {
            console.log(error);
        }
    ...
    const handleRemove = async (productId) => {
        try {
            const res = await axios.delete(`${API}/remove`, {
                ...
                data: { productId } // Note: axios.delete often requires a 'data' property for the body
            });
